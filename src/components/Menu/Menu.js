          ...
          <a onClick={() => null}>
            <BoxButton>
              <svg width="40" height="40" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14.7955 7.39493H6.20455C5.67477 7.39493 5.25 7.72635 5.25 8.13969V12.6082C5.25 13.0179 5.67477 13.353 6.20455 13.353H8.59091V14.0978H12.4091V13.353H14.7955C15.3205 13.353 15.7452 13.0179 15.7452 12.6082L15.75 8.13969C15.75 7.72635 15.3205 7.39493 14.7955 7.39493ZM14.7955 12.6082H6.20455V8.13969H14.7955V12.6082ZM12.4091 10.374L9.06818 11.8635V8.88445L12.4091 10.374Z" fill="#A3B5C9" />
              </svg>
            </BoxButton>
          </a>
          <a onClick={() => null}>
        ...
        <SidebarContainer className={open && "on"}>
          ...
          {open && (
            <>
              ...
              <div className="Menu-container" id="NavMobile">
                <BoxButton>
                  <svg
